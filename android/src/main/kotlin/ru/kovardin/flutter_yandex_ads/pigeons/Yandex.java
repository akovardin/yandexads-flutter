...
public class Yandex {
  ...
  public interface YandexAdsApi {
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable YandexAdsApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.flutter_yandex_ads.YandexAdsApi.initialize", getCodec());
        if (api != null) {
